...
for file in "$testFilingDir"/*.zip; do
    ...
    arelleCmdLine --plugins ixbrl-viewer -f $file --save-viewer $genDir/$viewerName --viewer-url ../../../../iXBRLViewerPlugin/viewer/dist/ixbrlviewer.dev.js --viewer-no-copy-script
